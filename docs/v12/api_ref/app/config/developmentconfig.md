...
|----------|------|-------------|
| **DEBUG** | `bool` = True | Enables or disables the debug mode for the local development environment. |
| **PAGE_SIZE** | `int` = 10 | Defines the number of items to be displayed per page in paginated responses. |
