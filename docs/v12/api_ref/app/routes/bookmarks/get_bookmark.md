---
{title: GET /< bookmark_id >, description: API Reference for app.routes.bookmarks.get_bookmark, section_id: app_routes_bookmarks_get_bookmark, section_type: function_ref}
---
# GET /< bookmark_id >
