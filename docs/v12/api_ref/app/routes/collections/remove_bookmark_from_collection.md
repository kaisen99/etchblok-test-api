---
{title: DELETE /< collection_id >/bookmarks/< bookmark_id >, description: API Reference for app.routes.collections.remove_bookmark_from_collection, section_id: app_routes_collections_remove_bookmark_from_collection, section_type: function_ref}
---
# DELETE /< collection_id >/bookmarks/< bookmark_id >
