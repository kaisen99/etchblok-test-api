...
| **per_page** | `int` = 25 | The number of bookmark items to include per page |
| **status** | `Optional[str]` = None | Optional status filter string such as 'active', 'archived', or 'trashed' |
...
| Name | Type | Description |
|------|------|-------------|
| **tag** | `[Tag](../../models/tag/tag.md?sid=app_models_tag_tag)` | The Tag object to be persisted or updated |
...
| Name | Type | Description |
|------|------|-------------|
| **collection** | `[Collection](../../models/collection/collection.md?sid=app_models_collection_collection)` | The Collection object to be persisted or updated |
