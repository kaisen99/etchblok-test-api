...
| Type | Description |
|------|-------------|
| `bool` | True if the bookmark was successfully added, False if the collection does not exist or addition failed |
...
| Type | Description |
|------|-------------|
| `bool` | True if the bookmark was successfully removed, False if the collection does not exist or removal failed |
