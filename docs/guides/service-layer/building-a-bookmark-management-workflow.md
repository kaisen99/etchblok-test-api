...
The `BookmarkService` provides a `full_text_search` method that performs a full-text search across all indexed bookmarks. This is useful for finding your bookmark later without knowing its ID.
